...
namespace _144Prisos.ModThings.DamageClasses
{
    public class GaottaDamageClass : DamageClass
    {
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            player.GetCritChance<GaottaDamageClass>() += 4;
            player.GetArmorPenetration<GaottaDamageClass>() += 10;
